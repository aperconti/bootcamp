...
console.log(`50 returns ${yScale(testScores[0])}`);
console.log(`75 returns ${yScale(testScores[3])}`);
console.log(`95 returns ${yScale(testScores[2])}`);
...
var students = ["Lucy", "Han", "Sarah", "Matt", "Ruchi"];
...
console.log(`Sarah's x-coordinate: ${xScale(students[2])}`);
console.log(`Matt's x-coordinate: ${xScale("Matt")}`);
console.log(`Ruchi's x-coordinate: ${xScale(students[4])}`);
...
console.log(`The height of Han's bar: ${yScale(testScores[1])}`);
