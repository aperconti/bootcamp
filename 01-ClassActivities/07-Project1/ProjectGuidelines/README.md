...
* [Awesome-APIs List](https://github.com/abhishekbanthia/Public-APIs)
...
Your project proposal will be the readme file in your project repository. It must include your proposal/outline, links to possible sources of data, and a cursory division of labor among group members. A link to that repository must be submitted for approval before you can begin project work.
